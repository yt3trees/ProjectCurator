...
public partial class EditorViewModel : ObservableObject
{
    ...
    public async Task OpenFileAsync(string path)
    {
        ...
        {
            await _dialogService.ShowMessageAsync("Error", $"Failed to open file:\n{ex.Message}");
        }
        finally
        {
            IsLoading = false;
    ...
    public async Task SaveAsync()
    {
        ...
        {
            await _dialogService.ShowMessageAsync("Error", $"Failed to save:\n{ex.Message}");
        }
    }
    ...
    public async Task ImportMeetingNotesAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            if (ShowScrollableError != null)
                ...
                await _dialogService.ShowMessageAsync("Import Meeting Notes", $"Analysis failed:\n{ex.Message}");
            return;
        }
        finally
        {
        ...
        {
            IsLoading = false;
            await _dialogService.ShowMessageAsync("Import Meeting Notes", $"Apply failed:\n{ex.Message}");
            return;
        }
        finally
        {
        ...
        await _dialogService.ShowMessageAsync("Import Meeting Notes", msgParts.ToString().TrimEnd());
    }
    ...
    public async Task NewAiDecisionLogAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            if (ShowScrollableError != null)
                ...
                await _dialogService.ShowMessageAsync("AI Decision Log", $"AI Decision Log failed:\n{ex.Message}");
        }
        finally
        {
            IsLoading = false;
    ...
    // =====================================================================
    [RelayCommand]
    public async Task DeleteDecisionLog(FileTreeNode? node)
    {
        ...
        {
            await _dialogService.ShowMessageAsync("Error", $"Failed to delete:\n{ex.Message}");
        }
    }
    ...
    public async Task UpdateFocusAsync()
    {
        ...
        try
        {
            ...
            _trayService.ShowNotification("Focus Update Ready", "Proposal is ready for review.");
        ...
        catch (Exception ex)
        {
            if (ShowScrollableError != null)
                ...
                await _dialogService.ShowMessageAsync("Update Focus", $"Update Focus failed:\n{ex.Message}");
        }
        finally
        {
            IsLoading = false;
